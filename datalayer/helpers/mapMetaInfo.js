    ...
    metaData.script = [
      {
        json: {
          ...
          '@type': 'Website',
          url: 'https://nostalgic-joliot-2055e1.netlify.app',
        },
    ...
    metaData.script = [
      {
        json: {
          ...
          contentUrl: `https://nostalgic-joliot-2055e1.netlify.app/videos/${fields.id}`,
    ...
    metaData.script = [
      {
        json: {
          ...
          url: `https://nostalgic-joliot-2055e1.netlify.app/writings/${fields.id}`,
